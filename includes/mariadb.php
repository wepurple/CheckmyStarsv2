...
try { //try
    ...
    $dns = 'mysql:host=localhost;dbname=gestion_des_cinema'; //indication sur le SGBDR utilisé et le nom de la base de données qu'on souhaite utilisé
    $utilisateur = 'root'; //identifiant
    $motDePasse = ''; //mot de passe

    $connection = new PDO( $dns, $utilisateur, $motDePasse ); // connnexion à la base de données
    $connection->exec("USE gestion_des_cinema");
