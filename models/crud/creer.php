...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if (!empty($data->Nom) && !empty($data->Prenom) && !empty($data->Civilite) && !empty($data->Telephone) && !empty($data->Email) && !empty($data->Adresse) && !empty($data->Complement) && !empty($data->CodePostal) && !empty($data->Ville) && !empty($data->Pays) && !empty($data->DateEnregistrement) && !empty($data->Societe) && !empty($data->Role) && !empty($data->Login) && !empty($data->MotDePasse)) {
        ...
        $user->Pays = $data->Pays;
        $user->DateEnregistrement = $data->DateEnregistrement;
