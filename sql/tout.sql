...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : jeu. 04 déc. 2025 à 10:19
...
--
CREATE DATABASE IF NOT EXISTS `checkmystars2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `checkmystars2`;
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=ascii COLLATE=ascii_general_ci;
...
(38, '14', 'bis', '41600', 'rue des bruyere', 'chaon', 'France'),
(42, '100000000000004', '12', '45000', 'rue du mont tah les fou', 'Orléans', 'France'),
(43, '14', '', '46100', 'rue des bruyes', 'chaon', 'France'),
(46, '14', '', '46100', 'rue des bruyes', 'chaon', 'France'),
(47, '100000000000004', '12', '45000', 'rue du mont tah les fou', 'Orléans', 'France');
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `nombre_dossiers` varchar(255) NOT NULL,
...
INSERT INTO `clients` (`nom`, `societe`, `telephone`, `mail`, `nombre_dossiers`, `status`) VALUES
('Georges Dupont', 'Foncia', '0758006713', 'georges@dupont.fr', '3', 1),
('Nathalie Portman', 'Jesaispas', '8744683678', 'nathalieportman@gmail.com', '1', 0);
...
(16, 'LEBIGOT', 'kylian', 'Monsieur', 'TerenceInc', 'mdr', 'kylian.dupont@example.com', '079df19451', NULL, 42),
(17, 'Bourdon Lopez', 'Angel', 'Madame', 'la pocatiere du cegp', '123', 'anbourdonlopez@stpbb.org+2', '0769155622', NULL, 43);
