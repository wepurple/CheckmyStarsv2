            ...
            <div class="row justify-content-center">
                <div id="carouselExampleIndicators" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        ...
                        <img src="img\hotel_img1.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                        <img src="img\hotel_img2.jpg" class="d-block w-100" alt="...">
                        </div>
                        <div class="carousel-item">
                        <img src="img\hotel_img3.jpg" class="d-block w-100" alt="...">
                        </div>
                    </div>
...
-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #464646 !important;">
                            <button onclick="window.location.href='critere_inspecteur_etoile.php?id=<?php echo $id; ?>'" type="button" class="btn">Voir l'evaluation</button>
                        </div>
                    </div>
                </div>
                <div class="col-md rounded">
