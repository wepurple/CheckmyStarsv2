    ...
    <body class="bg-secondary">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #464646 !important;">
                            <button type="button" class="btn" data-bs-target="#critere_inspecteur_etoile.php">Voir l'evaluation</button>
                        </div>
                    </div>
                </div>
                <div class="col-md rounded">
                                    ...
                                    try {
                                        ...
                                        if ($stmt->rowCount() > 0) {
                                            while($row = $stmt->fetch(PDO::FETCH_ASSOC)) { 
                                                ...
                                                echo "<td>" . htmlspecialchars($row['u.Utilisateurs_Nom']) . "</td>" . "</br>" . " " ;
                                                echo "<td>" . htmlspecialchars($row['u.Utilisateurs_Prenom']) . "</td>";
                                                echo "<td>" . htmlspecialchars($row['u.Utilisateurs_Mail']) . "</td>" . "</br>";
                                                echo "<td>" . htmlspecialchars($row['u.Utilisateurs_Telephone']) . "</td>" . "</br>";
                                            }
                                        } else {
                                            echo "<tr><td colspan='7' class='text-center'>Aucune donnée trouvée</td></tr>";
                                        }
