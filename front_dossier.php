    ...
    <body class="bg-secondary">
            ...
            <div class="row">
                ...
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #2b2b2b !important;">
                            <button type="button" class="btn" data-bs-toggle="info_modal">Voir la facture</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #464646 !important;">
                            <button type="button" class="btn" data-bs-toggle="info_modal">Voir l'evaluation</button>
                        </div>
                    </div>
                </div>
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #2b2b2b !important;">
                            <button type="button" class="btn" data-bs-toggle="info_modal">Voir l'adresse</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #464646 !important;">
                            <button type="button" class="btn" data-bs-toggle="info_modal">Voir la date du RDV</button>
                        </div>
                    </div>
                </div>
                <div class="col-md rounded">
                    <div class="card text-white rounded shadow-md border" style="background-color: #2b2b2b !important;">
                            <button type="button" class="btn" data-bs-toggle="info_modal">Voir l'etat du dossier</button>
                        </div>
                    </div>
                </div>
            </div>
